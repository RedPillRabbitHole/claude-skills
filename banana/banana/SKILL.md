---
name: banana
description: AI image generation Creative Director using Google Gemini. Use when user wants to generate, edit, or work with AI-generated images. Triggered by /banana commands or requests to generate/edit images with Gemini.
---
